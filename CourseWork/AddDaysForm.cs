...
namespace CourseWork
{
    public partial class AddDaysForm : Form
    {
        ...
        {
            Days = days;
            SettlingUntil.Text = HotelAdministrator.hotel.Rooms[Floor - 1, RoomNumber - 1].UnSettlingDate.AddDays(Days).ToString("dd-MM-yyyy");
        }
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            {
                HotelAdministrator.hotel.AddDays(Floor, RoomNumber, Days);
